      ...
      {cardItems.items.length > 0 && (
        <div className='border-4 border-purple-500 rounded-lg bg-slate-50 absolute top-20 w-96 right-10 p-4'>
          ...
          <div className='w-100% flex justify-end gap-4'>
            <button onClick={clearCardButton}
                    className='bg-white text-purple-500 px-4 py-2 rounded-md font-medium border-2 border-purple-500 hover:border-purple-700 hover:bg-purple-500 hover:text-white'>
              Clear Card
            </button>
